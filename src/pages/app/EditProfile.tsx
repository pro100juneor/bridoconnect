      ...
      <div className="px-4 py-4 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full bg-secondary rounded-2xl px-4 py-3 text-sm outline-none text-foreground resize-none focus:ring-2 focus:ring-accent/30 leading-relaxed"
          />
        </div>
        <Button
