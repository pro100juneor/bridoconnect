...
// Демо-данные витрины. host — имена собственные, их не переводим.
const featured = [
  {
    id: "1",
    titleKey: "live.demo.stream1.title",
    title: "Збір на ремонт будинку — Харків",
    host: "Оксана К.",
    flag: "🇺🇦",
    viewers: 234,
    live: true,
  },
  {
    id: "2",
    titleKey: "",
    title: "Humanitarian aid distribution live",
    host: "Relief UA",
    flag: "🇺🇦",
    viewers: 87,
    live: true,
  ...
  {
    id: "3",
    titleKey: "live.demo.stream3.title",
    title: "BridoConnect: як отримати допомогу",
    host: "BridoConnect",
    flag: "🇩🇪",
    viewers: 1240,
    live: false,
    ...
    <main className="min-h-screen bg-background">
      <section className="px-6 py-16 max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground mb-12 leading-relaxed">
          {t("live.publicSubtitle", "Дивись, як люди отримують допомогу в режимі реального часу.")}
        </p>
        <div className="space-y-4 mb-8">
          {featured.map((s, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`${isHero ? "h-48" : "h-32"} bg-primary/5 flex items-center justify-center relative`}
                >
                  <Radio
                    className={`${isHero ? "w-14 h-14" : "w-10 h-10"} text-primary/20`}
                    strokeWidth={1.75}
                  />
                ...
                <div className="p-3">
                  <p className={`font-semibold text-foreground ${isHero ? "text-base" : "text-sm"}`}>
        ...
        >
          {t("live.registerToWatch", "Зареєструватись щоб дивитись все")}
        </Button>
      </section>
    </main>
  );
